...
import io
import os
from face_recognition_service import generate_embedding, FaceValidationError, MODEL_NAME
...
async def face_embedding(file: UploadFile = File(...)):
    """Return a face embedding only to the trusted Node backend."""
    ...
    try:
        ...
        raise HTTPException(status_code=503, detail="Face recognition service is unavailable.") from exc
