...
import PatientDevicePairing from "../pages/PatientDevicePairing/PatientDevicePairing.jsx";
...
/>
      ...
      {/* ======================================================
          PATIENT DEVICE (pairing + dashboard)

          Deliberately OUTSIDE the shared <Layout /> — the
          Patient Device experience must be minimal and
          dementia-friendly, with no caregiver/doctor Navbar or
          Footer. Neither route uses normal JWT authentication;
          the dashboard guards itself using the device token
          (see patientDeviceStorage.js / patientDeviceAxios.js).
      ======================================================= */}

      <Route
        path={ROUTES.PATIENT_DEVICE_PAIR}
        element={
      ...
      <Route
        path={ROUTES.PATIENT_DEVICE_DASHBOARD}
        element={
          <PatientDashboard />
        }
      />
